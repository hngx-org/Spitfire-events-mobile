  ...
  return (
    <View style={styles.box}>
      ...
      <View style={{gap: 5, flex: 1}}>
        <TextOpen style={styles.title} font={"OpenSans_700Bold"}>
          Football Game
        </TextOpen>
        <TextOpen style={styles.date} font={"OpenSans_600SemiBold"}>
          May 20, 2023
        </TextOpen>
        <TextOpen style={styles.time} font={"OpenSans_600SemiBold"}>
          Friday 4-6pm
        </TextOpen>
        <TextOpen style={styles.location} font={"OpenSans_700Bold"}>
